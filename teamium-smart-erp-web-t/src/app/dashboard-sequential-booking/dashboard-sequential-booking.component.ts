...
@Component({
  selector: 'app-dashboard-sequential-booking',
  templateUrl: './dashboard-sequential-booking.component.html',
  styleUrls: ['./dashboard-sequential-booking.component.scss']
})
export class DashboardSequentialBookingComponent implements OnInit {
