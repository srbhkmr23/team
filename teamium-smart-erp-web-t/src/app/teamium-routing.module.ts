...
const routes: Routes = [
  {
    path: '', component: TeamiumComponent, canActivate: [AuthGuard],
    children: [
      ...
      { path:  'dashboard-booking',component:DashboardSequentialBookingComponent},
      ...
      {path:'sequential-booking/:id',component:SequentialBookingComponent},
      {path:'project-invoice/:id',component:ProjectInvoiceComponent},
      {path:'project-invoice/invoice-details/:id',component:InvoiceDetailsComponent},
      ...
      { path: 'staff-leave/:id', component: PersonnelLeaveComponent },
      ...
      { path: 'booking/packing-list/:id',component:CallsheetComponent},
       { path: 'booking/production-statement/:id',component:CallsheetComponent},
      { path: 'purchase-order/:id',component:CallsheetComponent}, 
      ...
      { path: 'show-budgeting/call-sheet/:id',component:ShowCallsheetComponent},
