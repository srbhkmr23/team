...
import { SaveColorComponent } from './configuration-components/save-color/save-color.component';

import {SharedModule} from './shared.module';
import { TeamiumRoutingModule } from './teamium-routing.module';
import { ShowCallsheetComponent } from './show-callsheet/show-callsheet.component';
import { LeaveFilterPipe } from './core/pipes/leave-filter.pipe';
import { LeaveRequestComponent } from './leave-request/leave-request.component';
import { SequentialBookingComponent } from './sequential-booking/sequential-booking.component';
import { CreateWorkOrderComponent } from './create-work-order/create-work-order.component';
import { RevenueModalComponent } from './dashboard-modals/revenue-modal/revenue-modal.component';
import { DashboardSequentialBookingComponent } from './dashboard-sequential-booking/dashboard-sequential-booking.component';
import { SidebarModalComponent } from './sidebar-modal/sidebar-modal.component';
import { ActualBudgetModalComponent } from './dashboard-modals/actual-budget-modal/actual-budget-modal.component';

import { BusinessFunctionModalComponent } from './dashboard-modals/business-function-modal/business-function-modal.component' 

import { BudgetingModalComponent } from './dashboard-modals/budgeting-modal/budgeting-modal.component';
import { SavePersonnelSkillComponent } from './configuration-components/save-personnel-skill/save-personnel-skill.component';
import { SaveTemplate } from './configuration-components/save-template/save-template.component';
import { EquipmentModalComponent } from './dashboard-modals/equipment-personal-modal/equipment-personal-modal.component';
import { DeleteConfirmModalComponent } from './delete-confirm-modal/delete-confirm-modal.component';
import { SaveKeywordComponent } from './configuration-components/save-keyword/save-keyword.component';
...
import { InvioceModalComponent } from './invioce-modal/invioce-modal.component';
import { InvoiceDetailsComponent } from './invoice-details/invoice-details.component';
import { SaveCurrencyComponent } from './configuration-components/save-currency/save-currency.component';
import { DigitalSignatureComponent } from './digital-signature/digital-signature.component';
import { SignaturePadModule } from 'angular2-signaturepad';
import { BookingconflictModalComponent } from './dashboard-modals/bookingconflict-modal/bookingconflict-modal.component';
...
import { RoundOffPipe } from './core/pipes/rounfoff.pipe';
...
@NgModule({
  ...
  declarations: [
    ...
    SaveDaysOFF,
    ShowCallsheetComponent,
    LeaveFilterPipe,
    LeaveRequestComponent,
    SequentialBookingComponent,
    SaveColorComponent,
    CreateWorkOrderComponent,
    DashboardSequentialBookingComponent,
    RevenueModalComponent,
    SidebarModalComponent,
    ActualBudgetModalComponent,
    SavePersonnelSkillComponent,
    BusinessFunctionModalComponent,
    BudgetingModalComponent,
    SaveTemplate,
    EquipmentModalComponent,
    DeleteConfirmModalComponent,
    SaveKeywordComponent,
    CurrencySearchPipe,
    ProjectInvoiceComponent,
    InvioceModalComponent,
    InvoiceDetailsComponent,
    SaveCurrencyComponent,
